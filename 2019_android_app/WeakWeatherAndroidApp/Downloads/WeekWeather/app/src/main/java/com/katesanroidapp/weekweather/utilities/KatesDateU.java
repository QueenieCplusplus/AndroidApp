...
public class KatesDateU{

    public static final long DAY_IN_MILLIS = TimeUnit.DAYS.toMillis(1); // from util.TimeUnit
    ...
    public static long getNormalizedUtcDateForToday() {
        ...
        TimeZone currentTimeZone = TimeZone.getDefault(); // from util.TimeZone
