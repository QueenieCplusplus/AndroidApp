...
import com.katesanroidapp.weekweather.utilities.WeatherUtils;

public class ForcastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder>  {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        String dateString = KatesDateU.getFriendlyDateString(mContext, dateInMillis, false);
