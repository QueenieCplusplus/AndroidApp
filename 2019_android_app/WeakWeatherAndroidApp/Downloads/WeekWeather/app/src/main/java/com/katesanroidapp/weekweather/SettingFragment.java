...
import com.katesanroidapp.weekweather.sync.utilities.KatesSyncUtils;
...
public class SettingFragment extends PreferenceFragmentCompat implements
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_location_key))) {
            ...
            KatesPreference.resetLocationCoordinates(activity);
            KatesSyncUtils.startImmediateSync(activity);
...
/**
 * The SettingsFragment serves as the display for all of the user's settings. In this app, the
