...
public class WeatherUtils {
    ...
    public static int getSmallArtResourceIdForWeatherCondition(int weatherId) {
     ...
     //by the OpenWeatherMap call. This method is very similar to {@link #getSmallArtResourceIdForWeatherCondition(int)}.
     ...
     // @param weatherId from OpenWeatherMap API response See http://openweathermap.org/weather-conditions for a list of all IDs
